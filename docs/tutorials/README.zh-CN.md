...
| 层级 | 面向谁 | 目标 | 入口 |
| --- | --- | --- | --- |
| 新手教程 | 第一天接触 TSPlay 的同学 | 跑通二进制、能理解 Lua / Flow 的基本关系 | [track-newbie.zh-CN.md](track-newbie.zh-CN.md) |
| 初级教程 | 已经能跑 demo、想进入真实业务动作的人 | 把文件、变量、控制流、HTTP、Redis、DB 基础连起来 | [track-junior.zh-CN.md](track-junior.zh-CN.md) |
