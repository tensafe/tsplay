...
write_json("artifacts/tutorials/50-use-session-batch-import-excel-lua.json", {
    lesson = "50",
    mode = "lua",
    page_url = page_url,
...
print("authenticated Excel batch import complete:", tostring(#results))
print("wrote artifacts/tutorials/50-use-session-batch-import-excel-lua.json")
