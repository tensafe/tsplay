...
write_json("artifacts/tutorials/30-browser-state-snapshot-pack-lua.json", {
    lesson = "30",
    mode = "lua",
    page_url = page_url,
    username = username,
...
print("captured browser state snapshot for:", tostring(username))
print("wrote artifacts/tutorials/30-browser-state-snapshot-pack-lua.json")
