...
write_json("artifacts/tutorials/76-query-external-sync-audit-history-lua.json", {
    lesson = "76",
    mode = "lua",
...
print("queried audit history for batch:", tostring(latest_batch_id))
print("wrote artifacts/tutorials/76-query-external-sync-audit-history-lua.json")
